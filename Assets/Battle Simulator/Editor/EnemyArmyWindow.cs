...
public class EnemyArmyWindow : EditorWindow {
    ...
    void OnGUI(){
		...
		GUILayout.Space(10);
		GUILayout.Label("QuanityLimit:");
		enemyArmyLevel.quanityLimit = EditorGUILayout.IntField(enemyArmyLevel.quanityLimit);
		...
		GUILayout.BeginHorizontal();
		scrollPos = EditorGUILayout.BeginScrollView(scrollPos, true, false, skin.horizontalScrollbar, GUIStyle.none, GUIStyle.none, GUILayout.Width(position.width - 290), GUILayout.Height(70));
		GUILayout.BeginHorizontal();
